...
public class Ejercicio_2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Consumo: " + l1.getConsumoEnergetico());
        System.out.println("Peso: "+ l1.getPeso());
        System.out.println("Carga: "+ l1.getCarga());
        ...
        System.out.println("Consumo: " + t1.getConsumoEnergetico());
        System.out.println("Peso: "+ t1.getPeso());
        System.out.println("Resolucion: "+ t1.getResolucion());
        System.out.println("TDT: "+ t1.getTdt());
